...
public class Main {
	public static void main(String[] args) {
		...
		EmployeeWage TataMotors = new EmployeeWage("Tata Motors", 20, 5);
		EmployeeWage Bridgelabz = new EmployeeWage("Bridelabz", 16, 6);
		EmployeeWage SamSolutions = new EmployeeWage("Sam Solutions", 25, 3);
